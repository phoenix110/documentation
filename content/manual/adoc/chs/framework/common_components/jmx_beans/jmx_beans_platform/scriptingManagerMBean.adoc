...
http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/core/jmx/ScriptingManagerMBean.html[ScriptingManagerMBean] 是 <<scripting,Scripting>> 基础接口的 JMX 外观设计模式实现。
