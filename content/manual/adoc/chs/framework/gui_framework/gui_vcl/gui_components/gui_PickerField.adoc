...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/gui/components/PickerField.html" class="api-docs-btn" target="_blank">API 文档</a>
</div>
++++
...
---- 
+
可以在编程时使用相应的组件事件来对标准操作进行参数化。比如，可以通过如下方式设置特定的查找界面 ID：
+
[source, java]
----
