...
<div class="manual-live-demo-container">
    <a href="https://demo.cuba-platform.com/dashboard" class="live-demo-btn" target="_blank">在线示例</a>
</div>
++++

++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/gui/components/CssLayout.html" class="api-docs-btn" target="_blank">API 文档</a>
</div>
++++
